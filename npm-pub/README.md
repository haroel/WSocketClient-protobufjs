...
注意：
- @frw/wsocket-client已包含protobufjs/ByteBuffer/Long，无需再额外安装！
- 拷贝 `node_modules/@frw/wsocket-client/proto-tools.zip` 到工程根目录，解压，proto-tools工具用于处理.proto文件，文档后续会详细讲解使用
...
// WSocketClient调用setProtoConfig传入proto_config 
```
